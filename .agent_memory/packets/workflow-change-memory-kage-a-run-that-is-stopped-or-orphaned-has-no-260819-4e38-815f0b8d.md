---
type: "Workflow"
title: "Change memory: kage/a-run-that-is-stopped-or-orphaned-has-no-260819-4e38"
description: "Repo-local context for 29 changed repo paths on kage/a-run-that-is-stopped-or-orphaned-has-no-260819-4e38."
...
tags: ["change-memory", "diff-proposal", "repo-local", "branch:kage-a-run-that-is-stopped-or-orphaned-has-no-260819-4e38"]
timestamp: "2026-08-19T15:53:59.649Z"
x-kage-id: "repo:https-github-com-kage-core-kage:workflow:change-memory-kage-a-run-that-is-stopped-or-orphaned-has-no-260819-4e38"
...
...exit-in-node-is-not-guaranteed-to-f-60e32e9c.md |   4 +-
 ...
 mcp/delegation/recovery.ts                         | 223 ---------------
 mcp/delegation/supervisor.ts                       |  53 +---
 mcp/delegation/verify.ts                           |  11 +-
 mcp/delegation/worktree-guard.ts                   | 117 --------
 mcp/run-recovery.test.ts                           | 303 ---------------------
 mcp/worktree-guard.test.ts                         | 108 --------
 19 files changed, 238 insertions(+), 1013 deletions(-)
